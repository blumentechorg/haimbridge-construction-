        ...
        <div className="service-wrap">
          <div className="service-title-left">
            <div className="wpo-section-title">
              ...
              <p>
                Lectus suspendisse mi massa et mollis diam urna interdum
                consequat. Libero quis non odio sed convallis cursus fames vitae
                volutpat. At congue viverra integer est. Quam convallis
                dignissim cras sit morbi diam.
              </p>
            ...
            <Slider {...settings}>
              {Services.map((service, Sitem) => (
                <div className="service-single-item" key={Sitem}>
                  <div className="icon">
                    <Image src={service.sImg} alt="" width={50} height={50} />
                  </div>
                  <div className="text">
                    <h2>
                      <Link
