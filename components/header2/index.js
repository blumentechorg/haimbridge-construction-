            ...
            <div className="row align-items-center">
              ...
              <div className="col col-xl-5 col-lg-8 col-md-1 col-1 ">
                ...
                >
                  ...
                  <ul className="nav navbar-nav mb-2 mb-lg-0 text-white">
                        ...
                        <li className="menu-item-has-children">
                          ...
                          <ul className="sub-menu">
                            <li>
                              <Link
                                onClick={ClickHandler}
                                href="/blog-single/The-Golden-Ratio-2D-Sketch"
                              >
                            ...
                            <li>
                              <Link
                                onClick={ClickHandler}
                                href="/blog-single-left-sidebar/The-Golden-Ratio-2D-Sketch"
                              >
                            ...
                            <li>
                              <Link
                                onClick={ClickHandler}
                                href="/blog-single-fullwidth/The-Golden-Ratio-2D-Sketch"
                              >
