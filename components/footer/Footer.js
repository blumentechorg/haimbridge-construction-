            ...
            <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
              <div className="widget link-widget">
                ...
                <div className="contact-ft">
                  <ul>
                    <li>
                      <i className="fi flaticon-email"></i>info@haimbridge.com
                    </li>
                    <li>
                    ...
                    <li>
                      <i className="fi flaticon-placeholder"></i>Gwarinpa,
                      Kadobunkuro 900108, Federal Capital Territory
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col col-xs-12">
              <p className="copyright">
                {" "}
                Copyright &copy; 2025 Haimbridge by{" "}
